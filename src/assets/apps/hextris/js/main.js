...
function showHelp() {
	...
	$("#inst_main_body").html("<div id='instructions_head'>游戏说明</div><p>不要让方块越过外侧灰色六边形。</p><p>" + (settings.platform != 'mobile' ? '使用键盘左右方向键' : '点击屏幕左右两侧') + "旋转六边形。" + (settings.platform != 'mobile' ? '按下方向键可让方块加速下落。' : '') + "</p><p>让 3 个或更多同色方块相连即可消除并得分。</p><p>外侧六边形上的彩色线条表示连击剩余时间。</p><hr><p id='afterhr'></p>原作：Logan Engstrom 与 Garrett Finucane");
	if (gameState == 1) {
		pause();
	}
